/* PSPDX Demo: a demo listing for PSPDX.
 *
...
PSP_MODULE_INFO("PSPDX Demo", 0, 1, 0);
...
int main(void)
{
	...
	pspDebugScreenPrintf("This is PSPDX Demo, a demo listing for PSPDX:\n");
	pspDebugScreenPrintf("a .pspdx in the repository, a release with the EBOOT,\n");
	pspDebugScreenPrintf("and the four pieces of media the XMB shows.\n\n");
